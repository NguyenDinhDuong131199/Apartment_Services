...
{
    public partial class DbApartmentManagement : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    linkVideo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LinkMap = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Areage = table.Column<float>(type: "real", nullable: false),
                    GetInTouch = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PypePostsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TypePostsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Posts_TypePosts_TypePostsId",
                        column: x => x.TypePostsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostCategories", x => new { x.PostsId, x.CatagoryId });
                    table.ForeignKey(
